...
const navigate = useNavigate();
  ...
  const handleLogin = (e) => {
    ...
    if (Object.keys(errosValidacao).length === 0) {
      alert("Ainda não funciona aguarde a criação do banco de dados");
    }
  };
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f3f4f6' }}>
      <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '0.5rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', maxWidth: '20rem', width: '100%' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0rem' }}>{/* O Botão de Login demanda uma validação com o banco de dados (MongoDB) */}
            ...
            >
              Login
            </button>{/* O Botão de Adicionar Usuário redirecionará para uma página de cadastro */}
